...
public class KnnClassifier {
    ...
    public static void main(String[] args) throws Exception{
        //Preprocess and convert text file into arff 
        TxtToArffConvertor arffConvertor = new TxtToArffConvertor();
        arffConvertor.Convert();
        //Data file on which the classifier is applied
        DataSource source = new DataSource("src/files/data.arff");
